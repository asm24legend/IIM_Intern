...
class DQNNetwork(nn.Module):
    def __init__(self, input_size, output_size):
        ...
        # Enhanced network architecture to better utilize rich state space
        # Larger hidden layers to capture complex state interactions
        self.fc1 = nn.Linear(input_size, 512)  # Increased for rich state processing
        self.fc2 = nn.Linear(512, 384)         # Deep processing layer
        self.fc3 = nn.Linear(384, 256)         # Feature combination layer
        self.fc4 = nn.Linear(256, 128)         # Decision layer
        self.fc5 = nn.Linear(128, output_size) # Output layer
